...
class OrganizationsTest < ApplicationSystemTestCase
  ...
  test "creating a Organization" do
    ...
    fill_in "Gender", with: @organization.gender
    fill_in "Issues", with: @organization.issues
    fill_in "Memberlink", with: @organization.memberlink
    fill_in "Mission", with: @organization.mission
    fill_in "Name", with: @organization.name
    fill_in "Race", with: @organization.race
